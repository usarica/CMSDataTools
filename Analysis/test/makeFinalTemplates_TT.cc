#ifndef MAKEFINALTEMPLATES_TT_H
#define MAKEFINALTEMPLATES_TT_H
...
void makeFinalTemplates_TT(const Channel channel, const ACHypothesis hypo, const SystematicVariationTypes syst, CategorizationHelpers::MassRegion massregion, const unsigned int istage=1, const TString fixedDate=""){
  const ProcessHandler::ProcessType proctype=ProcessHandler::kTT;
  if (channel==NChannels) return;
