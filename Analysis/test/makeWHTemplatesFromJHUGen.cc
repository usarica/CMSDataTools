...
void makeWHTemplatesFromJHUGen_one(const Channel channel, const Category category, const ACHypothesis hypo, const SystematicVariationTypes syst, const TString fixedDate="");
void makeWHTemplatesFromJHUGen_two(const Channel channel, const Category category, const ACHypothesis hypo, const SystematicVariationTypes syst, const TString fixedDate="");
void makeWHTemplatesFromJHUGen_checkstage(const Channel channel, const Category category, const ACHypothesis hypo, const SystematicVariationTypes syst, const unsigned int istage, const TString fixedDate="");
...
CheckStageFcn checkstagefcn = &makeWHTemplatesFromJHUGen_checkstage;
#endif
...
void makeWHTemplatesFromJHUGen_one(const Channel channel, const Category category, const ACHypothesis hypo, const SystematicVariationTypes syst, const TString fixedDate){
  ...
  strSampleIdentifiers.push_back("WH_Sig_JHUGen");
...
void makeWHTemplatesFromJHUGen_two(const Channel channel, const Category category, const ACHypothesis hypo, const SystematicVariationTypes syst, const TString fixedDate){
  ...
  if (gSystem->AccessPathName(cinput)) makeWHTemplatesFromJHUGen_one(channel, category, hypo, syst, fixedDate);
...
void makeWHTemplatesFromJHUGen_checkstage(
