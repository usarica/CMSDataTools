...
// First argument is name, second argument is type
#define SIMPLE_DATA_INPUT_DIRECTIVES \
SIMPLE_DATA_INPUT_DIRECTIVE(bool, bool) \
SIMPLE_DATA_INPUT_DIRECTIVE(uchar, unsigned char) \
SIMPLE_DATA_INPUT_DIRECTIVE(char, char) \
SIMPLE_DATA_INPUT_DIRECTIVE(ushort, unsigned short) \
SIMPLE_DATA_INPUT_DIRECTIVE(short, short) \
SIMPLE_DATA_INPUT_DIRECTIVE(uint, unsigned int) \
SIMPLE_DATA_INPUT_DIRECTIVE(int, int) \
SIMPLE_DATA_INPUT_DIRECTIVE(ulong, unsigned long) \
SIMPLE_DATA_INPUT_DIRECTIVE(long, long) \
SIMPLE_DATA_INPUT_DIRECTIVE(ulonglong, unsigned long long) \
SIMPLE_DATA_INPUT_DIRECTIVE(longlong, long long) \
SIMPLE_DATA_INPUT_DIRECTIVE(float, float) \
SIMPLE_DATA_INPUT_DIRECTIVE(double, double) \
SIMPLE_DATA_INPUT_DIRECTIVE(TBits, TBits) \
SIMPLE_DATA_INPUT_DIRECTIVE(string, std::string) \
SIMPLE_DATA_INPUT_DIRECTIVE(TString, TString) \
SIMPLE_DATA_INPUT_DIRECTIVE(CMSLorentzVector, CMSLorentzVector)
