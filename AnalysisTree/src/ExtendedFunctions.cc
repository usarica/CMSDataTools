...
void ExtendedFunctions::SimpleGaussian::setRange(RangeSetting rangeset_, double min_, double max_){
  rangeset=rangeset_;
  min=min_;
  max=max_;
}
void ExtendedFunctions::SimpleGaussian::setMean(double mean_){ mean=mean_; }
void ExtendedFunctions::SimpleGaussian::setSigma(double sigma_){ sigma=sigma_; }


ExtendedFunctions::PiecewisePolynomial::PiecewisePolynomial(const int nfcn_, const int polyndof_) :
...
ExtendedFunctions::PiecewisePolynomial::PiecewisePolynomial(ExtendedFunctions::PiecewisePolynomial const& other) :
...
void ExtendedFunctions::PiecewisePolynomial::setParameters(std::vector<double> const& par_){ par=par_; }

double ExtendedFunctions::PiecewisePolynomial::eval(double x){
