// Configuration options
{
	...
	"outputFile":"/home/ianderso/Work/HighMass/AnomalousCouplings/HiggsWidth_PostICHEP/LHC_7TeV/Analysis/Templates/Combine/4e/HtoZZ4l_MCFM_125p6_SmoothTemplates__GenLevelVBF_wResolution_D_Gamma_gg_r10_Nominal.root",
	...
	"templates":[
		...
		// T_VBF_1 
		{
			...
			"weight":"templateWeight",
			"conserveSumOfWeights":true,
			"selection":"ZZMass>=220 && ZZMass<=1600 && D_Gamma_gg_r10>=0 && D_Gamma_gg_r10<1",
			"assertion":"1",
			"binning":{
				"type":"fixed",
				"bins":[69,220.,1600.,30,0.,1.]
