// Configuration options
{
	...
	"outputFile":"<DIR>/LHC_7TeV/4e/HtoZZ4l_MCFM_125p6_SmoothTemplates__GenLevelVBF_D_Gamma_gg_r10_Nominal_nonDjet.root",
	...
	"templates":[
		// T_1 
		{
			"name":"T_2D_1",
			"files":[
				"./4e/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_D_Gamma_gg_r10_Nominal_nonDjet.root"
				],
			"tree":"T_2D_1_Tree",
		...
		// T_ZX_merged
		{
			"name":"T_2D_ZX_merged",
			"files":[
				"./4mu/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_D_Gamma_gg_r10_Nominal_nonDjet.root",
				"./4e/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_D_Gamma_gg_r10_Nominal_nonDjet.root",
				"./2mu2e/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_D_Gamma_gg_r10_Nominal_nonDjet.root"
				],
			"tree":"T_2D_ZX_Tree",
			"variables":["ZZMass","D_Gamma_gg_r10"],
			"weight":"templateWeight",
