// Configuration options
{
	...
	"outputFile":"/home/ianderso/Work/HighMass/AnomalousCouplings/HiggsWidth_PostICHEP/LHC_8TeV/Analysis/Templates/Combine/4mu/HtoZZ4l_MCFM_125p6_SmoothTemplates__GenLevelVBF_wResolution_D_Gamma_gg_r10_SysUp_ggQCD.root",
	...
	"templates":[
		// T_1 
		{
			"name":"T_2D_1",
			"files":[
				"./4mu/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_wResolution_D_Gamma_gg_r10_SysUp_ggQCD.root"
				],
			"tree":"T_2D_1_Tree",
		...
		// T_ZX_merged
		{
			...
			"files":[
				"./4mu/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_wResolution_D_Gamma_gg_r10_SysUp_ggQCD.root",
				"./4e/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_wResolution_D_Gamma_gg_r10_SysUp_ggQCD.root",
				"./2mu2e/HtoZZ4l_MCFM_125p6_ModifiedTemplateswithTreesForCombine__GenLevelVBF_wResolution_D_Gamma_gg_r10_SysUp_ggQCD.root"
				],
			"tree":"T_2D_ZX_Tree",
			"variables":["ZZMass","D_Gamma_gg_r10"],
			"weight":"templateWeight",
