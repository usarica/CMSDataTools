...
void getOnShellWeightsforfLQ_one(int erg_tev){
	...
	float mZZ;
	ggH->SetBranchAddress("GenZZMass",&mZZ);
	VBF->SetBranchAddress("ZZMass",&mZZ);
	...
	TH1D* ggH_ratios = new TH1D("ggH_ratios","ggH_ratios",3,0.,3g.);
	...
	TString outputname = "./data/m4l_ratios_" + erg_name + "TeV.root";  
